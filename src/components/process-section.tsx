 ...
 * offer so the homepage and /services/system always agree. Motion: an ink dot runs the length of it on a loop and
...
export function ProcessSection() {
  ...
  return (
    <Chapter id="how-it-works" title="Process" tone="system">
      <div className="container-page">
        ...
        <Reveal className="mt-12">
          <ol className="process relative grid gap-8 sm:grid-cols-5 sm:gap-4">
            {/* the connecting line (a plain rule: the runner supplies the motion) */}
            <span aria-hidden className="pointer-events-none absolute left-[0.7rem] top-0 h-full w-px bg-border sm:left-0 sm:top-[0.7rem] sm:h-px sm:w-full" />
