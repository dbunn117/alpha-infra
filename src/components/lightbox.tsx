...
/*
 * Click-to-enlarge for a screenshot. By default the thumbnail is the button
 * (keyboard reachable, labelled). Pass `children` to supply your own trigger
 * instead, e.g. a text button under a cropped view. The dialog handles focus
 * trapping, Escape, and focus return. The large image is the same asset, so
 * nothing extra loads.
 */
